...
The model performance worsened over time:
- week 1 had worse results than the January baseline (RMSE = 18.02; MAE = 10.89; R² = .878)
- week 2 was again slightly worse (RMSE = 21.83; MAE = 14.64; R² = .865)
- week 3 was the worst performance-wise (RMSE = 37.63; MAE = 24.67; R² = .729)
